...
#
# SCRIPT: Cliente de sockets TCP modificado para enviar comandos do sistemas para o servidor
#
...
sentence = input('Digite o nome do comando para executar no servidor: ')
